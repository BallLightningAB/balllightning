		...
		<SheetPortal>
			...
			<SheetPrimitiveContent
				className={cn(
					...
					side === "right" &&
						"data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-[min(100vw,28rem)] max-w-full border-l",
					side === "left" &&
						"data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-[min(100vw,28rem)] max-w-full border-r",
					side === "top" &&
